...
<template>
  <AuthenticatedLayout>
    <div class="row">
      <div class="xl:w-1/4 lg:w-1/2 sm:w-1/2">
        <Link :href="route('rooms.room.create')">
          <div class="card">
            <div class="card-body depostit-card p-5">
              <div
                class="depostit-card-media flex justify-between relative z-[2]"
              >
                <h6 class="font-bold">Agregar cuarto</h6>
            ...
            >
              <Link :href="route('rooms.room.show', room.id)">
                ...
                <h3 class="font-semibold leading-[1.346]">
                  <!-- {{ room.charge }} -->
                  <span class="text-[0.75rem]">100k</span>
                </h3>
              </Link>
              <!-- <div
                class="icon-box h-[2.5rem] w-[2.5rem] relative flex items-center justify-center rounded-md"
              ...
              >
                <i :class="room.status.icon"></i>
              </div> -->
            </div>
            <div class="progress-box mt-0">
              <div class="flex justify-between">
                <p class="mb-0">Porcentaje de uso</p>
                <p class="mb-0">%/80%</p>
              </div>
